...
export default class InfoModal extends React.Component {
  ...
  render() {
    return (
      <ReactCSSTransitionGroup transitionName="info-modal" transitionEnterTimeout={500} transitionLeaveTimeout={300}>
        <div className="overlay" id="modal">
          <div className="modal-content">
            ...
            <div>
              ...
              <ul>
                <li>1. I pick a
                  <strong>random secret number</strong>
                  between 1 to 100 and keep it hidden.</li>
                <li>2. You need to
                  <strong>guess</strong>
